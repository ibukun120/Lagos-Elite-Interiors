        ...
        <div className="container mx-auto px-4 text-center text-gray-500">
          ...
          <div className="grid md:grid-cols-3 gap-10 text-gray-700">
            <div className="p-8 bg-gray-100 rounded-lg">
              <div className="flex items-center justify-center mb-4 text-black"><AiOutlineAntDesign size={70}/> </div>
              <h3 className="text-2xl font-semibold mb-4">Interior Design</h3>
              <p>Bespoke designs tailored to your vision and lifestyle.</p>
            </div>
            <div className="p-8 bg-gray-100 rounded-lg">
              <div className="flex items-center justify-center mb-4 text-black"><SiRenovate  size={70}/></div>
              <h3 className="text-2xl font-semibold mb-4">Full Renovation</h3>
              <p>Complete transformations with premium materials.</p>
            </div>
            <div className="p-8 bg-gray-100 rounded-lg">
              <div className="flex items-center justify-center mb-4 text-black"><RiProgress3Fill size={70}/></div>
